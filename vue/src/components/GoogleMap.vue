    ...
    <div>  
      <div id="grid-container">
        ...
        <div id="input-area">
            ...
            Attraction Type: <input v-model="typeInput" type="input"/>
            Day:<input v-model="userDayInput" type="input"/>
            <button v-on:click="addToList">Search</button>
...
this.location = new window.google.maps.LatLng(this.location.lat, this.location.lng);
...
const request= {
  ...
  type: this.typeInput,//['tourist_attraction'],
